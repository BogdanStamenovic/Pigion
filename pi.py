...
- You have LIMITED state history, if a step takes many actions, you may forget early ones. In that case use the memory tool to store what you completed every now and then.7
